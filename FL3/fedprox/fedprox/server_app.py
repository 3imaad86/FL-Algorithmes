...
from fedprox.metrics_utils import (
...
from fedprox.task import Net, model_size_bytes
...
def main(grid: Grid, context: Context) -> None:
    ...
    print(f"[config] algo=FedProx mu={mu} partitioning={partitioning}{extra} "
    ...
    for round_idx in range(1, num_rounds + 1):
        result = strategy.start(
            ...
            train_config=ConfigRecord({"lr": lr, "mu": mu, "round": round_idx}),
            num_rounds=1,
        )
